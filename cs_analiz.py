...
# Sayfa Ayarları
st.set_page_config(page_title="CS Karakter Analizi v24", page_icon="🎯", layout="wide")
...
if veri is None:
    # Hata veren satır burasıydı, düzelttim:
    ...
    try:
        ...
        with st.form("fixed_syntax_form"):
        ...
        if submit:
            if tarz[0] == 0 or silah[0] == 0 or info[0] == 0 or harita[0] == 0 or saat[0] == 0 or ekonomi[0] == -1:
                ...
                girdi = np.array([tarz[0], silah[0], info[0], aim, harita
