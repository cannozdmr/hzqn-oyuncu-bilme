...
st.set_page_config(page_title="CS Karakter Analizi v20", page_icon="🎯", layout="wide")
...
st.markdown(
    ...
    .hzqn-logo {
        ...
        bottom: 20px;
        left: 20px;
        background-color: #333333; /* Siyah arka plan */
        color: white; /* Beyaz yazı */
        padding: 20px 20px;
        border-radius: 50%; /* Yuvarlak yapma */
        font-size: 28px; /* Daha büyük yazı */
        font-weight: bold;
        z-index: 1000;
        box-shadow: 2px 2px 10px rgba(0,0,0,0.5);
        border: 5px solid white; /* Daha kalın beyaz çerçeve */
...
if not os.path.exists(dosya_adi):
    ...
    try:
        ...
        with st.form("final_bw_logo_form"):
